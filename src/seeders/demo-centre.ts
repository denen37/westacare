...
import { FacilityType, FacilityCategory } from '../models/Centre';
    ...
    up: async (queryInterface: QueryInterface) => {
        const centres = [
            ...
            },
            {
                ...
                category: FacilityCategory.PUBLIC,
                userId: 2,
                createdAt: new Date(),
                updatedAt: new Date(),
            },
            ...
            },
            {
                ...
                category: FacilityCategory.MISSIONARY,
                userId: 4,
                createdAt: new Date(),
                updatedAt: new Date(),
            },
        ...
        await queryInterface.bulkInsert('centres', centres);
    },

    down: async (queryInterface: QueryInterface) => {
        await queryInterface.bulkDelete('centres', {});
    },
};
