...
const templateData = (body, username) => {
    return `
 <!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <style>
      ...
      .email-body h2 {
        font-size: 22px;
        margin-bottom: 20px;
        color: #0099B8; /* Same as footer color for consistency */
      }
      .email-body p {
        margin-bottom: 20px;
      }
  ...
  <body>
    <div class="email-container">
      ...
      <div class="email-body">
        <h2>Hello ${username !== null && username !== void 0 ? username : "user"},</h2>
        ${body}
        <p>
      ...
      <div class="email-footer">
        <p>
          © 2024 Westacare. All rights reserved.<br />
