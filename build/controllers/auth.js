...
const registerProvider = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Models_1.OTP.create({ email, otp: (0, modules_1.hash)(otp), expiresAt: otpExpiration });
...
const verifyOTP = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let otpRecord = yield Models_1.OTP.findOne({ where: { email, otp: (0, modules_1.hash)(otp) } });
    if (!otpRecord)
...
const sendOTP = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user)
        return (0, modules_1.handleResponse)(res, 404, false, 'User not found');
    let otp = (0, modules_1.randomId)(6).toString();
    let otpExpires = new Date(Date.now() + configSetup_1.default.OTP_EXPIRY_TIME * 60 * 1000);
    let otpRecord = yield Models_1.OTP.create({ email, otp: (0, modules_1.hash)(otp), expiresAt: otpExpires });
    let emailSendStatus;
